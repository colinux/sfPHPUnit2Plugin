...
class sfPHPUnitGenerateFunctionalTestTask extends sfPHPUnitGenerateBaseTask
{
  ...
  protected function configure()
  {
    ...
    new sfCommandArgument('name', sfCommandArgument::REQUIRED, 'The controller name to test'),
    ));
...
EOF;
  ...
  protected function execute($arguments = array(), $options = array())
  {
    ...
    $replacePairs = array(
    '{controller_class}' => $arguments['application'] . '_' . $arguments['name'],
    ...
    $this->logSection('help', 'run this test with: ./symfony phpunit:test-functional '.$arguments['application'].' '.$arguments['name']);
  }
}
